		...
		<>
			...
			>
				...
				<div className="flex-1 overflow-y-auto px-6 py-4">
					...
					>
						<div>
							<label htmlFor="tariff-code" className="block text-(--text-sm) font-medium">
								Code
							</label>
							<Input
								id="tariff-code"
						...
						<div>
							<label htmlFor="tariff-label" className="block text-(--text-sm) font-medium">
								Label
							</label>
							<Input
								id="tariff-label"
						...
						<div>
							<label htmlFor="tariff-description" className="block text-(--text-sm) font-medium">
