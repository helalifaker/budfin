					...
					>
						<thead>
							<tr className="bg-(--workspace-bg-subtle)">
								<th className="sticky left-0 z-10 bg-(--workspace-bg-subtle) px-3 py-2 text-left text-(--text-xs) font-semibold text-(--text-muted) uppercase tracking-(--grid-header-tracking) min-w-[180px]">
									Category
								</th>
								{MONTH_LABELS.map((m, idx) => {
									...
									return (
										<th
											key={m}
											className={cn(
												'px-3 py-2 text-right text-(--text-xs) font-semibold text-(--text-muted) uppercase tracking-(--grid-header-tracking) min-w-[100px]',
								...
								<th className="px-3 py-2 text-right text-(--text-xs) font-semibold text-(--text-muted) uppercase tracking-(--grid-header-tracking) min-w-[110px]">
									Annual
								</th>
							</tr>
						</thead>
