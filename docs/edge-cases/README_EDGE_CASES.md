...
**Date**: March 3, 2026  
**Scope**: BudFin v1.0 PRD for EFIR (École Française Internationale de Riyad) — NOTE: This analysis was prepared against PRD v1.0. The canonical PRD is now v2.0 (`docs/prd/BudFin_PRD_v2.1.md`). Review edge cases against v2.0 before implementation.
...
3. **Update** BudFin_PRD_v2.1.md (the canonical PRD) with resolutions for all 35 edge cases
4. **Create** Jira/Azure DevOps issues from EDGE_CASE_QUICK_REFERENCE.csv
