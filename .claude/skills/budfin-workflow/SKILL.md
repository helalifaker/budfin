...
description: >
  Shared BudFin workflow context for the repo-local command pack. Use when a
  workflow command needs phase gates, technical constraints, or handoffs to the
  project skills that keep the spec -> story -> implementation -> review loop
  consistent.
invocations:
